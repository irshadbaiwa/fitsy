...
export default function Header() {
  ...
  return (
    <div className="flex flex-row items-center justify-between px-1 py-2 md:px-4 z-50 bg-white">
      {/* Logo */}
      <Link href="/">
        <a className="flex flex-row items-center p-2">
          ...
          <div className="text-4xl text-primary font-bold italic">Fitsy</div>
        </a>
      </Link>
      {/* endblock */}
      ...
      <div className="relative lg:hidden">
        <button
          onClick={openMenu}
          className="m-1 rounded-md outline-none focus:ring-2 ring-primary"
        >
          <svg
            className="h-12 mx-4 py-1 px-2 fill-content"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
          >
        ...
        {open && (
          <div className="absolute top-0 right-0 bg-white p-2 rounded-md shadow flex flex-col items-center">
            <button
              onClick={closeMenu}
              className="rounded-md outline-none focus:ring-2 ring-primary text-left self-end"
            >
              <svg
                className="h-12 mx-4 py-1 px-2 fill-content"
                xmlns="http://www.w3.org/2000/svg"
